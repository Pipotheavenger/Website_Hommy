import"./main-Dbfd22MI.js";function x(){const n=document.getElementById("app");if(!n)return;n.innerHTML=`
    <!-- Hero Header -->
  ...
  `;const t=document.getElementById("toggle-cliente"),s=document.getElementById("toggle-profesional"),a=document.getElementById("content-container"),r=document.getElementById("cta-dynamic");t==null||t.addEventListener("click",()=>{i(t,s),a&&(a.innerHTML=d()),r&&(r.innerHTML=`
    ...
    `)}),s==null||s.addEventListener("click",()=>{i(s,t),a&&(a.innerHTML=c()),r&&(r.innerHTML=`
    ...
    `)});function i(l,o){l==null||l.classList.add("bg-white","text-primary","shadow-sm"),l==null||l.classList.remove("text-white/60","hover:text-white"),o==null||o.classList.remove("bg-white","text-primary","shadow-sm"),o==null||o.classList.add("text-white/60","hover:text-white")}}function d(){return`
    <section class="py-24 bg-background">
      <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
           ${e(1,"Publica tu proyecto","Describe lo que necesitas, añade fotos y define tu ubicación.","🎨")}
           ${e(2,"Recibe y compara","Obtén presupuestos de expertos verificados en minutos.","⚖️")}
           ${e(3,"Contrata con Escrow","El dinero se reserva de forma segura antes de empezar.","🛡️")}
           ${e(4,"Libera y califica","Envía el pago solo al terminar y califica al profesional.","✨")}
        </div>
      </div>
    </section>
  `}function c(){return`
    <section class="py-24 bg-background">
      <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
           ${e(1,"Crea tu perfil Pro","Registra tus servicios, zona y fotos de trabajos.","🛠️")}
           ${e(2,"Postúlate a proyectos","Envía presupuestos a clientes que te interesen.","📨")}
           ${e(3,"Asegura tu pago","Hommy garantiza el dinero antes de que te desplaces.","💰")}
           ${e(4,"Cobra y crece","Recibe tu dinero en 24h y gana sellos de calidad.","📈")}
        </div>
      </div>
    </section>
  `}function e(n,t,s,a){return`
    <div class="bg-white p-10 2xl:p-16 rounded-[40px] 2xl:rounded-[60px] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 group text-center md:text-left">
       <div class="text-4xl 2xl:text-6xl mb-6 grayscale group-hover:grayscale-0 transition-all">${a}</div>
       <div class="text-xs 2xl:text-lg font-bold text-primary mb-2 uppercase tracking-widest">Paso ${n}</div>
       <h3 class="text-xl 2xl:text-3xl font-bold text-secondary mb-4">${t}</h3>
       <p class="text-sm 2xl:text-xl text-secondary-light leading-relaxed">${s}</p>
    </div>
  `}x();

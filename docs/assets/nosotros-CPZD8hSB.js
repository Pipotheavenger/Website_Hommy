import"./main-Dbfd22MI.js";function r(){const e=document.getElementById("app");e&&(e.innerHTML=`
    ...
    <section class="py-24 2xl:py-32 bg-white text-center">
      <div class="container">
        ...
        <div class="max-w-4xl mx-auto 2xl:max-w-6xl space-y-12 2xl:space-y-20 relative">
          ...
          ${l("Enero 2023","El Comienzo","Idea original y primera ronda de inversión en Bogotá.","left")}
          ${l("Junio 2023","Lanzamiento Beta","Primeros 100 profesionales verificados se unen a la plataforma.","right")}
          ${l("Diciembre 2023","10,000 Servicios","Alcanzamos nuestro primer gran hito de servicios completados con éxito.","left")}
          ${l("Hoy","Expansión Nacional","Presencia en las principales ciudades y más de 50,000 usuarios.","right")}
        </div>
      </div>
    </section>
  ...
  `)}function l(e,a,s,i){const t=i==="left";return`
    <div class="relative flex flex-col md:flex-row items-center ${t?"md:flex-row-reverse":""}">
      <!-- Marker -->
      ...
      <!-- Content -->
      <div class="w-full md:w-1/2 pl-16 md:pl-0 ${t?"md:pr-16 md:text-right":"md:pl-16"}">
        <div class="text-sm 2xl:text-xl font-bold text-primary mb-2 uppercase tracking-widest">${e}</div>
        <h4 class="text-2xl 2xl:text-4xl font-bold text-secondary mb-3">${a}</h4>
        <p class="text-secondary-light 2xl:text-2xl leading-relaxed">${s}</p>
      </div>
    </div>
  `}r();

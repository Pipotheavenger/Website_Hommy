import"./main-Dbfd22MI.js";function i(){const e=document.getElementById("app");e&&(e.innerHTML=`
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 2xl:gap-20">
          ...
          <div class="bg-background rounded-[60px] 2xl:rounded-[100px] p-12 lg:p-20 2xl:p-32 border border-gray-100 shadow-sm relative overflow-hidden group">
            <div class="relative z-10">
              ...
              <ul class="space-y-6 2xl:space-y-10 mb-12">
                ${t("Publicación de proyectos ilimitada",!0)}
                ${t("Recibe múltiples presupuestos",!0)}
                ${t("Acceso a profesionales verificados",!0)}
                ${t("Soporte y garantía Hommy",!0)}
              </ul>
          ...
          <div class="bg-secondary rounded-[60px] 2xl:rounded-[100px] p-12 lg:p-20 2xl:p-32 text-white relative overflow-hidden group">
            <div class="relative z-10">
              ...
              <ul class="space-y-6 2xl:space-y-10 mb-12">
                ${t("Sin cuotas fijas mensuales",!1)}
                ${t("Perfiles de alto impacto visual",!1)}
                ${t("Herramientas de gestión Hommy Pro",!1)}
                ${t("Comisión justa por trabajo finalizado",!1)}
              </ul>
      ...
      <div class="container">
        ...
        <div class="block min-[560px]:hidden space-y-4 max-w-sm mx-auto">
          <div class="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100">
            <div class="space-y-6">
              ${s("🛡️","Seguridad:","100% Verificados","Tradicional: Riesgo / Manual")}
              ${s("🔒","Pagos:","Protección Escrow","Tradicional: Depósito directo")}
              ${s("⚖️","Legal:","Mediación Incluida","Tradicional: Sin respaldo")}
              ${s("💵","Publicar:","Sin Costo Fijo","Tradicional: Pago por aviso")}
              ${s("🎧","Soporte:","24/7 Humano","Tradicional: Solo email/bots")}
            </div>
          </div>
          ...
          <div class="overflow-x-auto scrollbar-hide">
            <table class="w-full text-left min-w-[500px]">
              ...
              <tbody class="divide-y divide-gray-100 text-secondary">
                ${l("Verificación de antecedentes","100% Verificados","No verificados")}
                ${l("Sistema de Pago Seguro","Protección Escrow","Pago directo riesgoso")}
                ${l("Garantía de Satisfacción","Mediación incluida","Sin respaldo")}
                ${l("Costo por publicar","Gratis","A veces pago")}
                ${l("Atención al cliente","24/7 Humano","Solo correo/Automático")}
              </tbody>
            </table>
          </div>
        </div>
  ...
  `)}function t(e,a){return`
    <li class="flex items-center space-x-4 2xl:space-x-6">
      <div class="flex-shrink-0 w-6 h-6 2xl:w-10 2xl:h-10 rounded-full ${a?"bg-primary/10 text-primary":"bg-white/10 text-white"} flex items-center justify-center">
      ...
      <span class="font-medium 2xl:text-xl ${a?"text-secondary":"text-white/80"}">${e}</span>
    </li>
  `}function l(e,a,o){return`
    <tr>
      <td class="p-4 md:p-8 2xl:p-12 font-bold text-xs md:text-sm 2xl:text-xl">${e}</td>
      ...
      <td class="p-4 md:p-8 2xl:p-12 text-center text-gray-400 text-[10px] md:text-sm 2xl:text-lg">${o}</td>
    </tr>
    ...
    <div class="flex items-start gap-4">
      ...
      <div class="flex-grow text-left">
        <div class="flex items-center justify-between">
          <span class="font-bold text-secondary text-lg">${a}</span>
        ...
        <div class="text-primary font-bold text-lg">${o}</div>
        <div class="text-gray-400 text-sm mt-0.5">${r}</div>
      </div>
    </div>
  `}i();

import"./main-Dbfd22MI.js";function x(){const e=document.getElementById("app");e&&(e.innerHTML=`
    <!-- Hero Section -->
    ...
    <section id="beneficios" class="py-24 2xl:py-32 bg-white text-center">
      ...
      <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 2xl:gap-20">
          ${a("Clientes Verificados","👤","Accede a una base constante de clientes que ya han sido validados por nuestro sistema.")}
          ${a("Pagos Garantizados","💰","Olvídate de cobrar. El cliente deposita antes de empezar y tú recibes tu dinero al terminar.")}
          ${a("Libertad Total","📅","Tú decides qué trabajos aceptar, en qué zonas trabajar y en qué horarios estar disponible.")}
        </div>
      </div>
    </section>
        ...
        <div class="bg-white rounded-[60px] 2xl:rounded-[100px] p-12 lg:p-24 2xl:p-32 shadow-sm border border-gray-100 flex flex-col lg:flex-row items-center gap-20 2xl:gap-32">
          <div class="lg:w-1/2">
            ...
            <div class="space-y-12 2xl:space-y-20">
              ${i(1,"Crea tu perfil profesional","Sube tus fotos, describe tu experiencia y selecciona tus categorías de trabajo.")}
              ${i(2,"Verifica tu identidad","Sube tus documentos para nuestro proceso de seguridad y obtén tu sello de verificado.")}
              ${i(3,"Recibe ofertas y trabaja","Te avisaremos cuando haya proyectos cerca de ti. Envía tu presupuesto y ¡listo!")}
            </div>
          </div>
          <div class="lg:w-1/2">
            <div class="relative">
    ...
    <section class="py-24 2xl:py-32 bg-white text-center">
      ...
      <div class="container max-w-4xl 2xl:max-w-6xl text-left">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 2xl:gap-10">
          ${l("🆔","Cédula de Ciudadanía")}
          ${l("📜","Antecedentes Judiciales")}
          ${l("📸","Fotos de trabajos previos")}
          ${l("☎️","2 Referencias personales")}
        </div>
      </div>
    </section>
  ...
  `)}function a(e,t,s){return`
    <div class="p-10 2xl:p-16 rounded-[32px] 2xl:rounded-[60px] bg-white border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-300 text-center group">
      <div class="text-5xl 2xl:text-7xl mb-8 group-hover:scale-110 transition-transform">${t}</div>
      <h3 class="text-xl 2xl:text-3xl font-bold text-secondary mb-4">${e}</h3>
      <p class="text-secondary-light 2xl:text-xl leading-relaxed">${s}</p>
    </div>
  `}function i(e,t,s){return`
    <div class="flex items-start space-x-6 2xl:space-x-10">
      ...
      <div>
        <h4 class="text-xl 2xl:text-3xl font-bold text-secondary mb-2">${t}</h4>
        <p class="text-secondary-light 2xl:text-xl leading-relaxed">${s}</p>
      </div>
    </div>
  `}function l(e,t){return`
    <div class="flex items-center p-6 2xl:p-10 bg-background rounded-2xl 2xl:rounded-[40px] border border-gray-100">
      ...
      <span class="font-bold text-secondary 2xl:text-2xl">${t}</span>
    </div>
  `}x();
